...
const CATEGORIES: CategorySpec[] = [
  ...
  { icon: 'package', title: 'SCA', description: 'Software composition analysis of open-source dependencies.', scanners: ['dependency-check', 'grype'], href: '/security-scanning?tab=SCA' },
  ...
  { icon: 'file', title: 'IaC Scanning', description: 'Infrastructure-as-code misconfiguration scanning.', scanners: ['checkov'], href: '/security-scanning?tab=IaC%20Scanning' },
  { icon: 'key', title: 'Secrets Detection', description: 'Hardcoded credentials and API keys in source and history.', scanners: ['gitleaks', 'trufflehog'], href: '/security-scanning?tab=Secrets%20Detection' },
  ...
  { icon: 'target', title: 'Web Security Testing', description: 'Templated web vulnerability scanning.', scanners: ['nuclei'], href: '/security-scanning?tab=Web%20Security%20Testing' },
...
export function SecurityScanningCenter() {
  ...
  return (
    <div className="min-w-0">
      ...
      {tab === 'SAST' && <ScanHistoryTable scannerKey="semgrep" scannerLabel="Semgrep" />}
      {tab === 'DAST' && (
      ...
      {tab === 'IaC Scanning' && <ScanHistoryTable scannerKey="checkov" scannerLabel="Checkov" />}
      {tab === 'Secrets Detection' && (
        <div className="flex flex-col gap-6">
      ...
      {tab === 'Web Security Testing' && <ScanHistoryTable scannerKey="nuclei" scannerLabel="Nuclei" />}
      {tab === 'Pentest' && (
