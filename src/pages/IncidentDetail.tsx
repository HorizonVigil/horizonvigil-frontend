...
export function IncidentDetail() {
  ...
  return (
    <div>
      <FilterBar title={`${incident.incident_number} — ${incident.title}`} breadcrumb={<Link to="/incidents" className="text-xs text-slate-400 hover:underline">← Incidents</Link>} showAccountFilter={false} showRegionFilter={false} showDateFilter={false} />
