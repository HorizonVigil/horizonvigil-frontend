    ...
    <div>
      ...
      {tab === 'Overview' ? (
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 text-sm text-slate-500 dark:text-slate-400">
          ...
          <p className="mt-2">Recommendations are generated each time you run "Sync Now" on an AWS account, from your discovered resource inventory — idle instances, unattached volumes, unreleased IPs, stale snapshots, and rightsizing candidates identified from real CloudWatch utilization data. Reserved Instance and Savings Plan recommendations are not generated yet — that's wired directly to each cloud's own recommendation engine and is on the roadmap, not silently faked in the meantime, which is why the Reserved Instances and Savings Plans tabs are empty today rather than showing placeholder numbers.</p>
