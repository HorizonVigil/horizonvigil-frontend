...
export function sampleAdvisorWorkspace(): AdvisorWorkspace {
  ...
  return {
    version: '1', retrievedAt: now, decisionsAvailable: true, canDecide: true,
    model: { available: false, label: 'Illustrative preview' },
    coverageNote: 'Sample scenario: three signals across two illustrative accounts. No customer data or cloud actions.',
    decisions: [],
    evidence: [
