...
export const NAV_MODULES: NavModule[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Global Search', to: RESOURCES, real: true },
      { label: 'Tags Explorer', to: RESOURCES, real: true },
      { label: 'Resource Health', to: RESOURCES, real: true },
      { label: 'Resource Cost', to: RESOURCES, real: true },
      { label: 'Resource Metrics', to: RESOURCES, real: true },
      { label: 'Recently Discovered', to: RESOURCES, real: true },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'ECR Repositories', to: RESOURCES, real: true },
