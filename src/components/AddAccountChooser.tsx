  ...
  return (
    <Modal open={open} onClose={onClose} title="Add Cloud Account">
      <div className="flex gap-3">
        <button type="button" onClick={() => onChoose('aws')} className="flex-1 text-left rounded-lg border border-slate-200 dark:border-slate-700 p-4 hover:border-brand-400 dark:hover:border-brand-500 hover:bg-brand-50/50 dark:hover:bg-brand-900/20 transition-colors">
        ...
        <button type="button" onClick={() => onChoose('gcp')} className="flex-1 text-left rounded-lg border border-slate-200 dark:border-slate-700 p-4 hover:border-brand-400 dark:hover:border-brand-500 hover:bg-brand-50/50 dark:hover:bg-brand-900/20 transition-colors">
        ...
        <button type="button" onClick={() => onChoose('azure')} className="flex-1 text-left rounded-lg border border-slate-200 dark:border-slate-700 p-4 hover:border-brand-400 dark:hover:border-brand-500 hover:bg-brand-50/50 dark:hover:bg-brand-900/20 transition-colors">
